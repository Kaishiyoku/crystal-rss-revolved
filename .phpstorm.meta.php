...
'cache.stores.octane.driver','cache.prefix','concurrency.default','cors.paths','cors.allowed_methods',
'cors.allowed_origins','cors.allowed_origins_patterns','cors.allowed_headers','cors.exposed_headers','cors.max_age',
'cors.supports_credentials','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\GitHub\\crystal-rss-revolved\\public\\storage','hashing.driver',
'hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit','hashing.argon.memory','hashing.argon.threads',
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','queue.default','queue.connections.sync.driver',
...
'session.same_site','session.partitioned','view.paths','view.compiled','app.name',
...
'app.aliases.Vite','app.available_locales','app.rss_crawler_retry_count','app.feed_items_per_page','app.months_after_pruning_feed_items',
'app.fetch_articles_not_older_than_months','app.contact_email','app.github_url','blurhash.width','blurhash.height',
...
'database.connections.sqlite.prefix_indexes','database.connections.sqlite.foreign_key_constraints','database.connections.sqlite.busy_timeout','database.connections.sqlite.journal_mode','database.connections.sqlite.synchronous',
...
'database.redis.horizon.database','database.redis.horizon.options.prefix','horizon.domain','horizon.path','horizon.use',
...
'horizon.environments.production.supervisor-1.maxProcesses','horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','inertia.ssr.enabled',
'inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths','inertia.page_extensions','inertia.testing.ensure_pages_exist',
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','inertia-breadcrumbs.middleware.enabled','inertia-breadcrumbs.middleware.group',
'inertia-breadcrumbs.collector','inertia-breadcrumbs.classifier','inertia-breadcrumbs.ignore_query','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.feed_updater.driver','logging.channels.feed_updater.path','logging.channels.feed_updater.level',
'logging.channels.feed_updater.days','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'modeltyper.run-after-migrate','modeltyper.output-file','modeltyper.output-file-path','modeltyper.global','modeltyper.global-namespace',
'modeltyper.json','modeltyper.use-enums','modeltyper.use-types','modeltyper.plurals','modeltyper.no-relations',
'modeltyper.optional-relations','modeltyper.no-hidden','modeltyper.no-counts','modeltyper.optional-counts','modeltyper.no-exists',
'modeltyper.optional-exists','modeltyper.no-sums','modeltyper.optional-sums','modeltyper.timestamps-date','modeltyper.optional-nullables',
'modeltyper.api-resources','modeltyper.fillables','modeltyper.fillable-suffix','modeltyper.custom_mappings','modeltyper.custom_relationships.singular',
'modeltyper.custom_relationships.plural','modeltyper.case.columns','modeltyper.case.relations','modeltyper.included_models','modeltyper.excluded_models',
...
'pulse.recorders.Laravel\\Pulse\\Recorders\\UserRequests.sample_rate','pulse.recorders.Laravel\\Pulse\\Recorders\\UserRequests.ignore','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'type-script-model-generator.output_directory','type-script-model-generator.model_directory','type-script-model-generator.import_directory','type-script-model-generator.ignored_models','type-script-model-generator.model_partials.0.name',
'type-script-model-generator.model_partials.0.model','type-script-model-generator.model_partials.0.fields','type-script-model-generator.inherited_types.0.name','type-script-model-generator.inherited_types.0.model','type-script-model-generator.inherited_types.0.additional_fields.0.name',
'type-script-model-generator.inherited_types.0.additional_fields.0.types','type-script-model-generator.inherited_types.1.name','type-script-model-generator.inherited_types.1.model','type-script-model-generator.inherited_types.1.additional_fields.0.name','type-script-model-generator.inherited_types.1.additional_fields.0.types',
'type-script-model-generator.inherited_types.2.name','type-script-model-generator.inherited_types.2.model','type-script-model-generator.inherited_types.2.additional_fields.0.name','type-script-model-generator.inherited_types.2.additional_fields.0.types','type-script-model-generator.inherited_types.2.additional_fields.1.name',
'type-script-model-generator.inherited_types.2.additional_fields.1.types','type-script-model-generator.inherited_type_partials.0.name','type-script-model-generator.inherited_type_partials.0.type','type-script-model-generator.inherited_type_partials.0.fields','debugbar.enabled',
...
'ide-helper.post_migrate','breadcrumbs.view','breadcrumbs.files','breadcrumbs.unnamed-route-exception','breadcrumbs.missing-route-bound-breadcrumb-exception',
...
'pulse::livewire.slow-requests','pulse::livewire.usage',);
...
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.GitHub.crystal-rss-revolved.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',
'auth.failed','auth.password','auth.throttle','category.feeds_count','dashboard.unread_articles',
'feed.feed_items_count','feed.last_failed_at','feed.purge','feed.no_purge','http-statuses.0',
...
'validation.alpha_dash','validation.alpha_num','validation.array','validation.ascii','validation.before',
...
'validation.ipv4','validation.ipv6','validation.json','validation.lowercase','validation.lt.array',
...
'validation.uppercase','validation.url','validation.uuid','validation.attributes.address','validation.attributes.age',
'validation.attributes.amount','validation.attributes.area','validation.attributes.available','validation.attributes.birthday','validation.attributes.body',
'validation.attributes.category_id','validation.attributes.city','validation.attributes.content','validation.attributes.country','validation.attributes.created_at',
...
'validation.attributes.excerpt','validation.attributes.favicon_url','validation.attributes.feed_url','validation.attributes.filter','validation.attributes.first_name',
'validation.attributes.gender','validation.attributes.group','validation.attributes.hour','validation.attributes.image','validation.attributes.language',
...
'validation.attributes.remember','validation.attributes.restored_at','validation.attributes.result_text_under_image','validation.attributes.role','validation.attributes.second',
'validation.attributes.sex','validation.attributes.short_text','validation.attributes.site_url','validation.attributes.size','validation.attributes.state',
...
'validation.attributes.title','validation.attributes.updated_at','validation.attributes.username','validation.attributes.year','validation.attributes.is_purgeable',
'validation.attributes.feed_id','validation.attributes.email_verified_at','validation.attributes.is_admin',);
