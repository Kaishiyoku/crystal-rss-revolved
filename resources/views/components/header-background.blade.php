<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" style="z-index: -1;" {{ $attributes->except('style') }}>
    <defs>
        <linearGradient id="pathGradient" x1="0" y1="0.5" x2="1" y2="0.5">
                <stop offset="0" stop-color="#7465dc"/>
            <stop offset="1" stop-color="#7e67ac"/>
        </linearGradient>
    </defs>
