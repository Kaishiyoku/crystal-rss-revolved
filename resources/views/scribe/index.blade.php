...
<head>
    ...
    <title>Crystal RSS Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="home">
                    <a href="#home">Home</a>
                                    ...
                                    <ul id="tocify-subheader-home" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="home-GETapi-user">
                        <a href="#home-GETapi-user">Retrieve own user</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="home-GETapi-v1-health_check">
                        <a href="#home-GETapi-v1-health_check">Healthcheck</a>
                    </li>
                                                    </ul>
                            </ul>
        ...
        <li>Last updated: January 13 2022</li>
    </ul>
</div>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <p>APIs for basic information</p>

            <h2 id="home-GETapi-user">Retrieve own user</h2>
...
<form id="form-GETapi-user" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <h2 id="home-GETapi-v1-health_check">Healthcheck</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/health_check" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<form id="form-GETapi-v1-health_check" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-health_check"
                    onclick="tryItOut('GETapi-v1-health_check');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-health_check"
                    onclick="cancelTryOut('GETapi-v1-health_check');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-health_check" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
...
<br>
<p>The status of this API (<code>true</code> or <code>false</code>).</p>
        </p>
            <p>
            <b><code>services</code></b>&nbsp;&nbsp;<small>object</small>  &nbsp;
<br>
<p>Map of each downstream service and their status (<code>true</code> or <code>false</code>).</p>
        </p>
