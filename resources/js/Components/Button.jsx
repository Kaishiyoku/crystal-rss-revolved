        ...
        <>
            ...
            <Component
                className={clsx(
                    ...
                    'rounded-lg px-4 py-3 sm:py-2',
                    {
                        'shadow focus:shadow-md dark:shadow-black': variant !== 'plain',
                        'text-white border-violet-800 bg-violet-500 hover:border-violet-900 hover:bg-violet-600 focus:ring-violet-600 dark:border-violet-500 dark:bg-violet-600 dark:hover:border-violet-600 dark:hover:bg-violet-700 dark:focus:ring-violet-500': variant === 'primary',
                        'text-gray-900 border-gray-300 bg-white hover:border-gray-400 hover:bg-gray-100 focus:ring-gray-300 dark:text-white dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500 dark:hover:bg-gray-600 dark:focus:ring-gray-600': variant === 'secondary',
