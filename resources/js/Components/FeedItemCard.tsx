			...
			<div className="flex flex-col @md:flex-row h-full">
				<div className="flex flex-col grow-0 mb-4 @md:mb-0 @md:mr-4">
					...
					<div className="pb-2 text-sm text-muted">
						...
						<div className="flex space-x-2 text-sm text-muted">
							...
							<div>{internalFeedItem.feed.name}</div>
						</div>
					</div>
				</div>
				...
				<div className="grow flex flex-col min-w-0">
					...
					{internalFeedItem.description && (
						<div className="grow">
							<div
								className="text-muted overflow-hidden line-clamp-6 xl:line-clamp-3 hyphens-auto break-words"
								lang={internalFeedItem.feed.language}
							>
								{internalFeedItem.description}
							</div>
						</div>
